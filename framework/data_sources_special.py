...
def shiller_snp500(taxes=False, inf_adj=False, tax_rate=0.25, cache=True):
    dv = get('MULTPL/SP500_DIV_MONTH@Q', interpolate=False, cache=cache)
    pr = get('MULTPL/SP500_INFLADJ_MONTH@Q', interpolate=False, cache=cache)
